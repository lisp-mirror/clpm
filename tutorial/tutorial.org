...
*** Linux
    ...
    + Download the latest tarball for your system. Assuming you are running an
      ...
      at
      [[https://files.clpm.dev/clpm/clpm-amd64-linux-gnu-v0.3.2.tar.gz]].
    + Download the signed digests for this version from
      [[https://files.clpm.dev/clpm/clpm-v0.3.2.DIGESTS.asc]].
    ...
    + Verify the signature on the digests file:
      #+begin_src shell
        gpg --decrypt clpm-v0.3.2.DIGESTS.asc
      #+end_src
    ...
    + Ensure the sha512 sum for the downloaded file matches the one from the
      digests file:
      #+begin_src shell
        sha512sum clpm-amd64-linux-gnu-v0.3.2.tar.gz
      #+end_src
    + Unpack the tarball:
      #+begin_src shell
        tar xf clpm-amd64-linux-gnu-v0.3.2.tar.gz
      #+end_src
    + Install CLPM:
      #+begin_src shell
        cd clpm-v0.3.2 && sudo sh ./install.sh
      #+end_src

*** MacOS

    + Download the latest tarball, currently located at
      [[https://files.clpm.dev/clpm/clpm-amd64-darwin-v0.3.2.tar.gz]]
    + Download the signed digests for this version from
      [[https://files.clpm.dev/clpm/clpm-v0.3.2.DIGESTS.asc]].
    + Download the CLPM Signing Key:
      #+begin_src shell
    ...
    + Ensure the sha512 sum for the downloaded file matches the one from the
      digests file:
      #+begin_src shell
        sha512sum clpm-amd64-darwin-v0.3.2.tar.gz
      #+end_src
    + Unpack the tarball:
      #+begin_src shell
        tar xf clpm-amd64-darwin-v0.3.2.tar.gz
      #+end_src
    + Install CLPM:
      #+begin_src shell
        cd clpm-v0.3.2 && sudo sh ./install.sh
...
*** Windows
    ...
    + Download the latest installer, currently located at
      [[https://files.clpm.dev/clpm/clpm-amd64-windows-v0.3.2.msi]].
    + Run the installer.
