...
** Prebuilt binaries
   ...
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1-darwin-amd64.tar.gz][clpm-0.4.0-alpha.1-darwin-amd64.tar.gz]] :: CLPM compiled for 64bit Mac OS.
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1-linux-amd64.tar.gz][clpm-0.4.0-alpha.1-linux-amd64.tar.gz]] :: CLPM compiled for 64bit Linux.
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1-linux-arm64.tar.gz][clpm-0.4.0-alpha.1-linux-arm64.tar.gz]] :: CLPM compiled for 64bit Linux
     on ARM processors.
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1-linux-arm.tar.gz][clpm-0.4.0-alpha.1-linux-arm.tar.gz]] :: CLPM compiled for 32bit Linux
     on ARM processors.
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1-windows-amd64.msi][clpm-0.4.0-alpha.1-windows-amd64.msi]] :: CLPM installer for 64 bit Windows.
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1.tar.gz][clpm-0.4.0-alpha.1.tar.gz]] :: Source code, including git submodules.
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1.DIGESTS][clpm-v0.4.0-alpha.1.DIGESTS]] :: Text file containing the SHA512 sums for
     every previously mentioned file.
   + [[https://files.clpm.dev/clpm/clpm-0.4.0-alpha.1.DIGESTS.asc][clpm-0.4.0-alpha.1.DIGESTS.asc]] :: Same as =clpm-v0.4.0-alpha.1.DIGESTS=,
