...
(defclass requirement ()
  ((name
    ...
    :documentation "The name of the thing being required. Typically a string,
but may be other objects (like pathnames).")
   (source
    :initarg :source
    :initform nil
    :reader requirement/source
    :documentation "If non-NIL, the requirement must be satisfied using releases
provided by this source."))
  (:documentation "Base class for all requirements."))
...
(defclass versioned-requirement (requirement)
  ((version-spec
    ...
    :documentation "The version specifier that must be satisfied."))
  (:documentation "A requirement that can specify a version that needs to be
satisfied."))
...
(defclass git-requirement (requirement)
  ((repo
    ...
    :documentation "String containing the repo URL.")
   (branch
    :initarg :branch
    :initform nil
    :reader requirement/branch
    :documentation "If non-NIL, string naming the required branch.")
   (commit
    :initarg :commit
    :initform nil
    :reader requirement/commit
    :documentation "If non-NIL, string naming the required commit.")
   (tag
    :initarg :tag
    :initform nil
    :reader requirement/tag
    :documentation "If non-NIL, string naming the required tag."))
  (:documentation "A requirement on something that must be fetched from git."))

(defclass project-requirement (versioned-requirement)
  ()
  (:documentation "A requirement on the presence a project."))

(defclass system-requirement (versioned-requirement)
  ()
  (:documentation "A requirement on the presence of a system."))
...
(defclass git-project-requirement (git-requirement)
  ((systems
    ...
    :documentation "A list of system names to require.")
   (system-files
    :initarg :system-files
    :initform nil
    :reader requirement/system-files
    :documentation "A list of system files to require."))
  (:documentation "A requirement on the presence of a project retrieved from
git. If both systems and system-files are NIL, requires all systems in all asd
files defined in the project."))

(defclass fs-system-requirement (requirement)
  ((pathname
    :initarg :pathname
    :accessor requirement/pathname
    :documentation "The pathname to the asd file containing this system."))
  (:documentation "Requirement stating that a system must come from an asd file
located on the local filesystem."))

(defclass fs-system-file-requirement (requirement)
  ()
  (:documentation "Requirement stating that all systems from an asd file located
on the local filesystem must be included. NAME is the pathname to the asd
file."))
...
(defgeneric convert-asd-system-spec-to-req (dep)
  (:documentation "Given an ASD dependency specification, return the
requirement object it represents."))
